...
class MainActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tvModulo: TextView = findViewById(R.id.tvModulo)
        tvModulo.setOnClickListener {
            tvExpression.text = tvExpression.text.toString() + "%"
        }
        val tvSin: TextView = findViewById(R.id.tvSin)
        tvSin.setOnClickListener {
            tvExpression.text = tvExpression.text.toString() + "sin"
        }
        val tvTh: TextView = findViewById(R.id.tvTh)
        tvTh.setOnClickListener {
            tvExpression.text = tvExpression.text.toString() + "tanh"
        }
