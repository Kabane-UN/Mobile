...
class Tride extends StatefulWidget {
  const Tride({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<Tride> createState() => _TrideState();
}

class _TrideState extends State<Tride> {
  late Scene _scene;
  late Object _skull;
  ...
  void _onSceneCreated(Scene scene) {
    ...
    _skull = Object(
        ...
        lighting: true,
        fileName: 'assets/Skull/untitled.obj'
    );
    _neskull = Object(
        position: Vector3(0.0, 0.0, 0.0),
        scale: Vector3(5, 5, 5),
